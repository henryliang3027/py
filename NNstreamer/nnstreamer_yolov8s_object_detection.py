...
class Demo:
  ...
  def build_pipeline(self):
    ...
    if self.framework == 'neuronsdk':
      ...
      cmd += (f'tensor_filter framework=neuronsdk throughput={self.THROUGHPUT} name=nn '
              ...
              f'outputtype=float32,float32,float32 output=80:80:144:1,40:40:144:1,20:20:144:1 !')
  ...
  def tflite_init(self):
      tflite_model = 'yolov8s_fp32.tflite'   # rename your converted model to this
      dla = 'yolov8s_fp32.dla'
      tflite_label = 'coco_labels.txt'
